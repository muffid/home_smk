        ...
        <div class="container position-relative">
            <div class="row gy-5" data-aos="fade-in">
                <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center text-lg-start">
                    <h3 class="text-center text-lg-start fw-bold">PPDB SMK Budi Mulia Pakisaji 2025/2026</h3>
                    <p>Langkah Awal Menuju Sukses Karier Impianmu!</p>
                    <p> 🔹 Ingin siap bekerja setelah lulus?<br>
                        🔹 Mau mengasah keterampilan di bidang favoritmu?</p>
                ...
                <div class="col-lg-6 order-1 order-lg-2 ">
                    <img src=" img/g1.png" class=" img-fluid animated mobile-margin ">
