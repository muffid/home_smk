  ...
  <section id="hero">
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <!-- Slide 2 -->
        <div class="carousel-item" style="background-image: url(assets/aset/baner/banner444.webp)">
          <div class="carousel-container">
            <div class="container">
        ...
        <!-- Slide 5 -->
        <div class="carousel-item" style="background-image: url(assets/aset/baner/banner333.webp)">
          <div class="carousel-container">
            <div class="container">
        ...
        <section id="why-us" class="sambutan">
          <div class="container" data-aos="fade-up">
            ...
            <div class="row justify-content-center">
              ...
              <div class="col-lg-6 col-12 align-items-stretch video-box order-1 order-lg-2" data-aos="zoom-in" data-aos-delay="100" style="min-height:0;">
             ...
             @forelse ($terbaru as $caro)
                <div class="item">
                    <div class="card bg-none border-0 shadow">
                        <img src="{{$caro->gambar}}" class="w-100 rounded-3" alt="{{$caro->judul}}" style="height: 200px;object-fit: cover;">
                    </div>
                    <div class="d-flex justify-content-center">
                        <div class="card border-0 p-2 text-center d-flex mb-5 shadow justify-content-center align-items-center" style="z-index:1000; margin-top:-45px; width:90%;">
                            <a href="{{$caro->url}}" class="stretched-link"><h6 class="text-dark">{{$caro->judul}}</h6></a>
                        </div>
                    </div>
                </div>
                @empty
              ...
              <div class="col-md-4 order-1 order-lg-1 order-md-1 mt-3 mb-2">
                <div class="card brd rounded-0">
                  <div class="card-body crd">
                    ...
                    @if ($berita == false )
                        <img src="https://img.freepik.com/premium-vector/funny-hoax-fake-news-illustration-background_188398-1511.jpg?size=338&ext=jpg&ga=GA1.2.665208692.1679989737&semt=ais" alt="No announcements" class="img-fluid w-100">
                    @else
                  ...
                  <div class="card-body crd text-light mb-5">
                    ...
                    @else
                        @forelse ($prestasi as $item)
                              <li>
                                <p class="" style="font-size: 12px; margin-bottom: -4px; color:#FFA500; font-weight:500;">
                                    @php
                                    $updated_at = \Carbon\Carbon::parse($item->created_at);
                                    $now = \Carbon\Carbon::now();
                                    if ($updated_at->lt($now->subDays(1))) {
                                ...
                                <a href="https://smkbudimuliapakisaji.sch.id/{{$item->url}}" class="text-white" style="font-size: 13px; font-weight:500;">{{$item->judul}}</a>
                              </li><hr>
                            @empty
                        @endforelse
                    @endif
      ...
      <div class="container" data-aos="zoom-in">
        <div class="text-center pt-4">
          ...
          <div class="row counters">
            ...
            <div class="col-lg-3 col-6 text-center">
              <span data-purecounter-start="0" data-purecounter-end="1582" data-purecounter-duration="2" class="purecounter"></span>
              <p>Alumni</p>
            </div>
