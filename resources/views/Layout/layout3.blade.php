...
<head>
    ...
    <meta name="keywords" content="Berita, smk, SMK, Smk, bm, Budi Mulia, budi mulia, BERITA, 2023/2024, pakisaji, malang">
    ...
    <nav id="navbar" class="navbar navbar-expand-lg navbar-dark fixed-top">
        <div class="container">
          ...
          <div class"justify-content-end>
            ...
            <button type="button" class="btn text-white bg-transparent d-inline d-lg-none" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
          ...
          <div style="width: 70%" class="offcanvas offcanvas-end mobil" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
              ...
              <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
               ...
               <li class="nav-item">
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link {{ Request::is('profil', 'guru', 'kegiatan') ? 'active' : '' }}" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <button type="button" class="btn text-white bg-transparent d-none d-lg-inline" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
             <i class="bi bi-search"></i>
            </button>
              ...
              <button type="button" class="btn-close bg-light" data-bs-dismiss="modal" aria-label="Close"></button>
                ...
                <form action="/search" role="search">
                        <div class="input-group mb-3">
                          <input type="search" name="keyword" class="form-control" placeholder="Cari Berita" aria-label="Search" aria-describedby="button-addon2" required>
                          <button class="btn text-white" type="submit" id="button-addon2" style="background-color:#00A7AE;"><i class="bi bi-search"></i></button>
                        </div>
                    </form>
              </div>
            </div>
