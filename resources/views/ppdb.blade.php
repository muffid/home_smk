...
@section('title', 'PPDB SMK BM Pakisaji')
@section('content')
<section>
  <!-- ======= Hero Section ======= -->
    ...
    <div class="container position-relative">
        <div class="row gy-5" data-aos="fade-in">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center text-lg-start">
            <h2>PPDB Online</h2>
            <p>Untuk calon pendaftar tahun ajaran 2024/2025 bisa mendaftar melalui website ini atau langsung datang ke tempat pendaftaran</p>
          ...
          <div class="col-lg-6 order-1 order-lg-2">
            <img src="img/10089.png" class="img-fluid animated">
          </div>
        </div>
      </div>
  </section>
  ...
  <section id="about" class="about mt-0">
    <div class="container aos-init aos-animate" data-aos="fade-up"> 
        <div class="row align-items-center">
            <div class="col-lg-5 order-1 order-lg-1 aos-init" data-aos="fade-up" data-aos-delay="100">
                <img src="img/img4.png" class="img-fluid" alt="Gedung2">
            </div>
            <div class="col-lg-7 pt-4 pt-lg-0 order-2 order-lg-2 content">
                <h3>Ada Apa di SMK Budi Mulia Pakisaji?</h3>
                <p>SMK Budi Mulia Terdapat 4 Kompetensi Keahlian Unggulan & Milenial yang bisa dipilih sesuai dengan minat kalian, Diantaranya :</p>
                <ul>
                    <li><i class="bi bi-check2-circle"></i> TKJ (Teknik Komputer & Jaringan)</li>
                    <li><i class="bi bi-check2-circle"></i> DKV (Desain Komunikaasi Visual)</li>
                    <li><i class="bi bi-check2-circle"></i> BD (Bisnis Daring)</li>
                    <li><i class="bi bi-check2-circle"></i> SIJA (Sistem Informasi Jaringan Aplikasi)</li>
                </ul>
                <br>
                <p><b>Eitss</b> bukan itu saja, Selain itu kita juga memiliki kelas yang hanya ada di SMK Budi Mulia. 
                pasti kamu bertanya tanya "Kelas bagaimana tuh?" , yaudah ni kukasih tau ya namanya <b>Double Degree</b></p>
    ...
    <div class="container aos-init aos-animate mt-5" data-aos="fade-up"> 
        <div class="row align-items-center">
            ...
            <div class="col-lg-7 pt-4 pt-lg-0 order-1 order-lg-1 content">
                ...
                <p><b>Double Degree</b> adalah kelas yang dimana Selain Mendapat Ijazah siswa - siswi yang tergabung  dalam kelas ini akan mendapat sertifikat kompetensi dari industri rekanan</p>
                ...
                <ul>
                    ...
                    <li><i class="bi bi-check2-circle"></i> MIIA & Barber</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container aos-init aos-animate mt-5" data-aos="fade-up"> 
        <div class="row align-items-center">
            ...
            <p>Dengan Bergabung di SMK budi Mulia Pakisaji Kalian tidak Menunggu <b>LULUS</b> Baru bisa Dapat <b>PENGHASILAN</b> Tapi Saat <b>SEKOLAH</b> Kalian Sudah Bisa Dapat <b>Gaji</b> & dapat <b>Bersekolah Gratis</b>.</p>
    ...
    <div class="container aos-init aos-animate mt-3" data-aos="fade-up"> 
        <div class="row align-items-center">
            ...
            <div class="col-lg-8 pt-4 pt-lg-0 order-1 order-lg-1 content">
                <!--<p><b>Free</b> Formulir Untuk Pendaftaran di Bulan <b>Desember</b></p>-->
                <p>jadi gimana Kalian Tertarik gak nih?? Segera Daftarkan Diri Kalian Disini dan dapatkan bonus menarik lainnya <b>bagi 100 pendaftar pertama</b>. untuk daftar bisa klik link di bawah ini</p>
            </div>
        </div>
    </div>
  ...
  <section id="" class="container text-center my-0">
    <div class="row justify-content-around">
        ...
        <div class="col-6">
            ...
            <a href="https://api.whatsapp.com/send?phone=6289513009008&text=Hai%20admin,%0Aboleh%20tanya%20tentang%20*PPDB%20SMK%20Budi%20Mulia%20Pakisaji*" class="btn-get-started text-center text-white"  style="font-size:13px;">
