...
<head>
    ...
    <meta property="og:image" content="https://smkbudimuliapakisaji.sch.id/assets/aset/005441cb-ab2b-4c72-bfe9-6b8aa15f0ee5.png" />
          ...
          <div style="width: 70%" class="offcanvas offcanvas-end mobil" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
            ...
            <div class="offcanvas-body">
              <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                ...
                <li class="nav-item">
                  <a class="nav-link {{ Request::is('#gel') ? 'active' : '' }}" href="#gel">Daftar Gelombang</a>
                </li>
              </ul>
            </div>
          </div>
...
<script type="module">
  ...
  const firebaseConfig = {
    apiKey: "AIzaSyAZWoabpVgElBqr3sFB1f_oUcWE6SCJqPI",
    authDomain: "ppdb-1a645.firebaseapp.com",
    projectId: "ppdb-1a645",
    storageBucket: "ppdb-1a645.appspot.com",
    messagingSenderId: "1028992912290",
    appId: "1:1028992912290:web:a8ef5fb67793c040a280fb",
    measurementId: "G-L5L8YZ0F1B"
  };
